                                ...
                                <div key={index+"item"} className="flex w-full rounded-md my-2 bg-white shadow-sm h-32 grid-cols-[128px,1fr]">
                                    ...
                                    <div className=" relative py-2 px-4 w-full flex flex-col gap-1">
                                        ...
                                        <div className="flex justify-between items-center">
                                            <p className="font-medium text-lg">{displayINRCurrency(item?.productId?.sellingPrice)}</p>
                                            <p className="font-semibold text-lg">Total: {displayINRCurrency((item?.productId?.sellingPrice) * item?.quantity)}</p>
                                        </div>
