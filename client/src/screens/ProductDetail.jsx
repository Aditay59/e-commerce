            ...
            
            {
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex items-center justify-start gap-2'>
                        <p className='font-medium text-2xl md:text-3xl'> {displayINRCurrency(product?.sellingPrice)} </p>
                        <p className='text-slate-400 text-xl line-through'> {displayINRCurrency(product?.price)} </p>
                    </div>
